package com.jc.android.component.pulltorefresh;
...
public class PullToRefreshLayout extends RelativeLayout
{
    ...
    private  boolean isGrayColor;//显示文字的颜色
    // 默认上拉头
        ...
        switch (refreshResult)
        {
            case SUCCEED:
                ...
                if (null == customLoadmoreView)
                {
                    ...
                    ((Pullable)pullableView).scollUpOne();
    ...
    private void initView()
    {
        ...
        if (null == customRefreshView)
        {
            ...
            if(isGrayColor) {
                refreshStateTextView.setTextColor(getResources().getColor(R.color.gray));
            }
        ...
        if (null == customLoadmoreView)
        {
            ...
            if(isGrayColor) {
                loadStateTextView.setTextColor(getResources().getColor(R.color.gray));
            }
