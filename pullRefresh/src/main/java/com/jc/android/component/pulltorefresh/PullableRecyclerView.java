...
public class PullableRecyclerView extends WrapRecyclerView implements Pullable
{
    ...
    public boolean canPullDown()
    {
        ...
        return (0==count || (mFirstVisiblePosition==0)&&(lm.findViewByPosition(mFirstVisiblePosition).getTop()>=0));
//        if (0 == count) {
//            // 没有item的时候也可以下拉刷新
//            return true;
//        } else {
//            return mFirstVisiblePosition == 0;
//        }
...
//        }
    ...
    @Override
    public void scollUpOne(){
       scrollToPosition(getLastVisiblePosition()+1);
    }
